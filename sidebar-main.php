  ...
  <div class="sidebar">
      <div class="form-search">
          <form action="<?php echo home_url(); ?>" method="get" id="courses_search_form"
              class="courses_search_form d-flex flex-row align-items-center justify-content-start">
              <input type="search" name="s" value="<?php the_search_query(); ?>" class="courses_search_input"
                  required="required" placeholder="検索文字を入力">
